...
namespace Valve.VR.InteractionSystem
{
	...
	public class Teleport : MonoBehaviour
    {
		...
		private void InitiateTeleportFade()
		{
			...
			Invoke("smellengine",currentFadeTime/3);
		...
		private void smellengine(){
			...
			Invoke("smellstop",currentFadeTime/2);
		}
		private void smellstop(){
			arduinoManager.click3();
			Debug.Log(currentFadeTime-(currentFadeTime/2 + currentFadeTime/3)+"df");
			Invoke("stop",currentFadeTime-(currentFadeTime/2 + currentFadeTime/3));
		...
		private void TeleportPlayer()
		{
			...
			if ( teleportPoint != null )
			{
				...
				Debug.Log("teleported to \"" + teleportPoint.name + "\"");
